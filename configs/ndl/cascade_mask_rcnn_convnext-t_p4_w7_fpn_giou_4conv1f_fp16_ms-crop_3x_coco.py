...
log_level = 'INFO'
load_from = None
resume_from = 'checkpoints/cascade_mask_rcnn_convnext-t_p4_w7_fpn_giou_4conv1f_fp16_ms-crop_3x_coco_20220509_204200-8f07c40b.pth'
workflow = [('train', 1)]
...
num_classes = 17
work_dir = 'workdirs/work_dir_path/'
gpu_ids = [0]
auto_resume = False
